        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php }
                    if (!$row) {
                        echo '<p style="margin-bottom: 5%;"><i class="fas fa-chevron-right"></i> CS50\'s Introduction to Computer Science - Harvard University, USA ( EDX )&nbsp;<a href="https://www.edx.org/course/cs50s-introduction-to-computer-science" title="visit course page" target="_blank"><button class="btn btn-link text-muted">  <i class="fas fa-external-link-alt"> visit</i>  </button></a><a title="view certificate" href="#"><button class="btn btn-link text-muted">  <i class="fas fa-graduation-cap"> details</i> </button></a></p>';
                    }
